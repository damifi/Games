document.addEventListener('DOMContentLoaded', () => {
    ...
    //function to check if a player wins or looses
    function checkBoard() {
        ...
        //check if the squares ALL have player-one or if ALL squares have player-two
       
    }

    //add onclick event to every sqaure
    for (let i = 0; i < squares.length; i++) {
        squares[i].onclick = () => {
          ...
          } else alert('invalid square selected')
          checkBoard()
        }
      }
